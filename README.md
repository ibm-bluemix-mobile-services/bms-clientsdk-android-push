...
- [Initialize SDK](#initialize-sdk)
	- [Include client Push SDK with Gradle](#includes-dk-with-gradle)
	- [Initialize the Core SDK and Push SDK](#initialize-with-push-sdk)
- [Register for notifications](#register-for-notifications)
	- [Receiving push notifications](receive-notications-android)
	- [Un-registering from notifications](#unregister-from-notifications)
