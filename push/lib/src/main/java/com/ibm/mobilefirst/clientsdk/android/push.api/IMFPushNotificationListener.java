 ...
 */
public interface IMFPushNotificationListener {
	 ...
	 *
	 * @param message
	 *            An IMFPushMessage object that contains the data / properties
	 *            received as part of the notification
	 */
	public void onReceive(IMFSimplePushNotification message);
