 ...
 */
public class IMFPushException extends Exception {
	...
	/**
	 * Constructor to create a IMFPushException
	 *
	 * @param e  root cause exception
	 */
	public IMFPushException(Exception e) {
		super(e);
	}
	 ...
	 */
	public IMFPushException(String message) {
		super(message);
	}

    /**
     * Create a IMFPushException with the below information
     *
     ...
     */
    public IMFPushException(int statusCode, String statusLine, String errorMessage,
    ...
    public IMFPushException(int statusCode, String statusLine) {
