...
/**
 * IMFPushBroadcastReceiver receives GCM messages and delivers them to
 * <class>com.ibm.mobile.services.push.IMFPushIntentService</class>.
 *
 ...
 * <application>
 * ....
 *  	<receiver android:name="com.ibm.mobile.services.push.IMFPushBroadcastReceiver"
 ...
 */
public class IMFPushBroadcastReceiver extends WakefulBroadcastReceiver {

	@Override
	public void onReceive(Context context, Intent intent) {
			ComponentName component = new ComponentName(
					context.getPackageName(),
					IMFPushIntentService.class.getName());
