 ...
 */
public class IMFCoreResponseListener implements ResponseListener {

    @Override
    public void onSuccess(Response response) {
        //Success response.
        System.out.println("Request Succeeded. Response is: " + response);
    }

    @Override
    public void onFailure(FailResponse failResponse, Throwable throwable) {
        System.out.println("Request Failed. Response is: "+ failResponse);
