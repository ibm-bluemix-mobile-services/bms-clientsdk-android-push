 ...
 */
public class IMFSimplePushNotification extends IMFAbstractPushMessage implements
		IMFPushMessage {
	private String url;
	private String payload;

	IMFSimplePushNotification(String alert, String id,
	...
	IMFSimplePushNotification(IMFInternalPushMessage message) {
		super(message);
	...
	public String toString() {
		return "IMFSimplePushNotification :{url:" + url + ", payload:"
				+ payload + ", alert:" + alert + "}";
	}
